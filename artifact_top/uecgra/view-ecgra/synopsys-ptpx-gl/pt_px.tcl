...
#
# Author : Shady Agwa, Yanghui Ou, Peitian Pan
# Date   : Sep 20, 2019
#
...
set pt_clk clk
set pt_uut tbench_${pt_design_name}/${pt_design_name}
...
report_power -cell_power -groups clock_network > ${pt_reports}/${pt_design_name}.clk_network.rpt
# Clock network hierarchical power report
report_power -hierarchy -groups clock_network > ${pt_reports}/${pt_design_name}.clk_network.hier.rpt
