...
def decode_inst_name( inst ):
  ...
  rs1    = tinyrv2_field_slice_rs1
  rd     = tinyrv2_field_slice_rd
  i_imm  = tinyrv2_field_slice_i_imm
  ...
  if inst == 0b00000000000000000000000000010011: inst_name = "nop"
    ...
    if   inst[funct7] == 0b0000000:
      ...
      elif inst[funct3] == 0b001:     inst_name = "mulh"
      elif inst[funct3] == 0b010:     inst_name = "mulhsu"
      elif inst[funct3] == 0b011:     inst_name = "mulhu"
      elif inst[funct3] == 0b100:     inst_name = "div"
      elif inst[funct3] == 0b101:     inst_name = "divu"
      elif inst[funct3] == 0b110:     inst_name = "rem"
      elif inst[funct3] == 0b111:     inst_name = "remu"
    ...
    elif inst[funct3] == 0 and inst[rs1] == 0 and inst[rd] == 0:
      if   inst[i_imm] == 0:          inst_name = "ecall"
      elif inst[i_imm] == 1:          inst_name = "ebreak"
