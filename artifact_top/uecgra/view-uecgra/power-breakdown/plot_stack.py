...
def plot_stack( plt_dict, bar_names=None, ylabel='', outdir='power_breakdown.pdf' ):
  ...
  for data in plt_dict.values():
    data = np.array( data )
    stack_lst.append( plt.bar( ind, data, width, bottom=cur_bottom ) )
    cur_bottom += data
