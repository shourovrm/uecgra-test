...
def join_data( jpath_dict={} ):
  ...
  q_w_path = 'in_qs__2'
  q_e_path = 'in_qs__3'
  sup_n_path = 'suppress/suppressors__0'
  sup_s_path = 'suppress/suppressors__1'
  sup_w_path = 'suppress/suppressors__2'
  sup_e_path = 'suppress/suppressors__3'
  ...
  for bname, data in data_dict.items():
    ...
    plt_dict[ 'suppress' ].append(
      data[ sup_n_path ]['switch_pwr'] + data[ sup_n_path ]['int_pwr'] + \
      data[ sup_s_path ]['switch_pwr'] + data[ sup_s_path ]['int_pwr'] + \
      data[ sup_w_path ]['switch_pwr'] + data[ sup_w_path ]['int_pwr'] + \
      data[ sup_e_path ]['switch_pwr'] + data[ sup_e_path ]['int_pwr']
    )
    plt_dict[ 'unsafe_gen' ].append( data[ unsafe_gen_path ]['switch_pwr'] + data[ unsafe_gen_path ]['int_pwr']   )
    plt_dict[ 'clk_switcher' ].append( data[ clk_switcher_path ]['switch_pwr'] + data[ clk_switcher_path ]['int_pwr']   )
